...
public struct O365ConnectorCard: CardType {
    ...
    public init(
        ...
        expectedActors: [String]? = nil,
        originator: String? = nil,
        summary: String? = nil,
        themeColor: String? = nil,
        hideOriginalBody: Bool? = nil,
        title: String,
        text: String? = nil,
...
extension O365ConnectorCard {
    ...
    public struct ActionCardAction: Codable {
        ...
        public init(
            name: String,
            inputs: [Input]? = nil,
            actions: [O365ConnectorCard.Action]? = nil
        ) {
...
extension O365ConnectorCard.ActionCardAction {
    ...
    public enum Input: Codable {
        ...
        public static func multichoice(
            id: String,
            isRequired: Bool? = nil,
            title: String,
            value: String? = nil,
            choices: [MultichoiceInput.Choice],
            isMultiSelect: Bool? = nil,
            style: MultichoiceInput.Style? = nil
        ) -> Self {
